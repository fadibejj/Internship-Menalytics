...
while totalNumberOfSeats != sum(seatsRepartitionPerList['Total Seats']):
    ...
    if seatsRepartitionPerList.loc[seatsRepartitionPerList['Decimal']==maxDecimal,'Decimal Duplicates'].values[0]==False:   #if no decimal duplicates (= false), +1 to the max decimal list
    ...
    elif seatsRepartitionPerList.loc[seatsRepartitionPerList['Decimal']==maxDecimal,'Decimal Duplicates'].values[0]==True:  #else if there are decimal duplicates (= false)      
        ...
        if seatsRepartitionPerList.loc[(seatsRepartitionPerList['Decimal']==maxDecimal) & (seatsRepartitionPerList['Total Seats']==maxSeats),'Seats Duplicates'].values[0]==False:  #if there are no seat duplicates (= false), +1 to the max decimal and max seats list
        ...
        elif seatsRepartitionPerList.loc[(seatsRepartitionPerList['Decimal']==maxDecimal) & (seatsRepartitionPerList['Total Seats']==maxSeats),'Seats Duplicates'].values[0]==True: #else if there are seats duplicates, +1 to the max pref votes candidate of the two max decimal&seats list
            ...
            maxCandidate = max(votesDF.loc[(votesDF['List']==duplicateSeatsList1) | (votesDF['List']==duplicateSeatsList2), 'Pref Votes %'])
            maxCandidateList = votesDF.loc[votesDF['Pref Votes %']==maxCandidate,'List'].values[0]
