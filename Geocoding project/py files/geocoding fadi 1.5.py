...
class geoLocation:
    def __init__(self, api_key=None):       # key constructor, default is None
        self.setKey = api_key
    def getLocation(self, csvFile):         # getLocation function, requires csv file input
        key=self.setKey
        ...
        for location in city_list:
            try:
                ...
                latlong = geocode['geometry']['location'] # get the latitude and longitude keys
...
#            print (latlong['lng'])
            ...
            townsGeoLocationDF.loc[city_list == location,'Latitude'] = latlong['lat']   # add the column Latitude
...
#geoLocation("AIzaSyC2ZU5N06KKcSaIML04djtCk8jWmLYe-jI").getLocation("BaldaAdjustedDF.csv")
geoLocation().splitCsv("BaldaAdjustedDFprocessed.csv")
print('finish')
